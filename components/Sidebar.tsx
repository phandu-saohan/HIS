...
const allMenuItems = {
    ...
    'Lâm sàng': [
        { id: 'Reception', label: 'Tiếp đón & Nhận bệnh', icon: <UserPlusIcon/> },
...
const Sidebar: React.FC<SidebarProps> = ({ activeComponent, setActiveComponent, currentUserRole }) => {
    ...
    const rolePermissions: Record<UserRole, string[]> = {
        'Bác sĩ/Y sĩ': ['Dashboard', 'Reception', 'PatientRegistration', 'OPDManagement', 'IPDManagement', 'EMR', 'AppointmentSchedule', 'OTSchedule', 'LIS', 'RISPACS', 'NursingInformationSystem', 'PatientDetail', 'AIChat'],
        'Điều dưỡng': ['Dashboard', 'BedManagement', 'NursingInformationSystem', 'IPDManagement', 'QueueManagement', 'Reception', 'PatientRegistration', 'PatientDetail', 'AIChat'],
        'Nhân viên Đăng ký/Tiếp tân': ['Reception', 'PatientRegistration', 'AppointmentSchedule', 'QueueManagement', 'ServiceBilling', 'PatientDetail'],
